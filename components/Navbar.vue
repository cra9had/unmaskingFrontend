<template>
  <!-- мобильное меню -->
  <section :class="{'mobile-menu': true, 'mobile-menu--open': mobileMenuOpened}">
    <div class="container">
      <nav class="mobile-menu__wrapper">
        <ul class="mobile-menu__list">
          <li class="mobile-menu__item-name">{{ UserDetails.username }}</li>
          <li
              class="mobile-menu__item-link mobile-menu__item-link--data"
          >
            <button type="button" @click="toPersonSettings">Персональные данные</button>
          </li>
          <li
              class="mobile-menu__item-link mobile-menu__item-link--history"
          >
...
<!--  header-preloader&#45;&#45;off-->
    ...
    <div class="container header__inner">
      ...
      >
        ...
        <nav class="menu">
          ...
          <button :class="{'menu__button': true, 'menu__button--open': !menuOpened}" @click="this.menuOpened=!this.menuOpened">
            <img
                width="36"
                height="36"
          ...
          <ul :class="{'menu__list': true, 'menu__list--open': this.menuOpened}">
      ...
      <button
          ...
          id="log-button"
          @click="this.authPopupOpened=true"
          v-else
      >
        Войти
      </button>
  ...
  <auth-popup :authPopupOpened="authPopupOpened" @auth="onAuth" @close="this.authPopupOpened=false"></auth-popup>
</template>
