  ...
  <div class="popup-log popup" v-if="authPopupOpened">
    <div class="popup-log__content popup__content">
      ...
      <form
          ...
          :class="{'popup-form': true, 'popup-log__form': true, 'popup-content--active': loginTabOpened}"
      >
        ...
        <div
            class="popup-log popup-log__input-wrapper input-password__wrapper"
        >
          <label
              for="log-password"
              class="label-hidden"
...
<!--        <captcha class="g-recaptcha" v-model:token="loginCaptchaToken" ref="loginCaptcha"></captcha>-->
      ...
      >
        ...
        <captcha class="g-recaptcha" v-model:token="registerCaptchaToken" ref="registerCaptcha"></captcha>
        <button
            type="submit"
            class="button popup__button"
        >
...
export default {
  ...
  methods: {
    ...
    async register() {
      if (!this.registerCaptchaToken || this.registerPassword !== this.registerPasswordConfirm){
        return
      }
